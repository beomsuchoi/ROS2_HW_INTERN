...
#include <memory>
#include "../../../../include/turtlesim_control/qnode.hpp"
...
QT_MOC_LITERAL(3, 19, 15), // "cmdVelPublished"
QT_MOC_LITERAL(4, 35, 4) // "data"

    },
    "QNode\0rosShutDown\0\0cmdVelPublished\0"
    "data"
};
...
void QNode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->cmdVelPublished((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNode::cmdVelPublished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void QNode::cmdVelPublished(QString _t1)
{
